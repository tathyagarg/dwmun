...
export default function UNSC() {
    ...
    return <div className="comm-content">
        ...
        <div className="bg-guide" onMouseMove={handleMouseMove}>
            <a href='https://drive.google.com/file/d/1cTm6YDnyGOKjox335_2a9i58v8bSzGit/view?usp=sharing'>
                <h1>Background</h1>
                <h1>Guide</h1>
                <p>Available now!</p>
            </a>
        ...
        <div className="matrix" onMouseMove={handleMouseMove}>
            ...
            <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTkwWKYZ9zowk2fsNEyyEbD7xAhUR5sEFBC7oQdl8FL4p53SNfBggNG6Cyxw4b2h2R86Dwbj99yiWnP/pubhtml?gid=212126292&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
            {/* <h2>Coming Soon!</h2> */}
        </div>
    </div>
}